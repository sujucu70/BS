        ...
        <div className="container mx-auto p-4 md:p-8 bg-[#f8f9fa] min-h-screen">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-8 border border-gray-200">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">Número total de llamadas recibidas al mes</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent"
                                />
                                <p className="text-xs text-gray-500 mt-1">TMO promedio por llamada</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent"
                                />
                                <p className="text-xs text-gray-500 mt-1">Coste total por hora (salario + cargas + overhead)</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a5f] focus:border-transparent"
                                />
                                <p className="text-xs text-gray-500 mt-1">Satisfacción actual del cliente</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <input
                                        ...
                                        className="flex-1"
                                    />
                                    <span className="text-2xl font-bold text-[#1e3a5f] w-16 text-right">
                                        {inputs.automationRate}%
                                    </span>
                                </div>
                                <p className="text-xs text-gray-500 mt-1">% de llamadas que pueden ser automatizadas</p>
                            </div>
                        </div>

                        {/* Investment Summary */}
                        <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            <h3 className="font-bold text-gray-800 mb-2">Inversión BeyondCX</h3>
                            <div className="space-y-1 text-sm">
                                <div className="flex justify-between">
                                    <span className="text-gray-600">Implementación (one-time):</span>
                                    <span className="font-semibold">{formatCurrency(implementationCost)}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-600">Licencia mensual:</span>
                    ...
                    <div className="space-y-6">
                        {/* ROI Highlight */}
                        <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2d5a8f] text-white rounded-xl shadow-lg p-8">
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center p-4 bg-green-50 rounded-lg">
                                    <span className="text-gray-700 font-medium">Ahorro mensual</span>
                                    <span className="text-2xl font-bold text-green-700">
                                        {formatCurrency(results.savings.monthly)}
                                    </span>
                                </div>
                                <div className="flex justify-between items-center p-4 bg-green-50 rounded-lg">
                                    <span className="text-gray-700 font-medium">Ahorro anual</span>
                                    <span className="text-2xl font-bold text-green-700">
                                        {formatCurrency(results.savings.annual)}
                                    </span>
                                </div>
                                <div className="flex justify-between items-center p-4 bg-blue-50 rounded-lg">
                                    <span className="text-gray-700 font-medium">Reducción de costes</span>
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="text-sm text-gray-600 mb-1">Llamadas automatizadas</div>
                                    <div className="text-2xl font-bold text-[#1e3a5f]">
                                        {formatNumber(results.withBeyondCX.automatedCalls)}
                                    </div>
                                    <div className="text-xs text-gray-500">{inputs.automationRate}% del volumen</div>
                                </div>
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="text-sm text-gray-600 mb-1">Horas ahorradas/mes</div>
                                    <div className="text-2xl font-bold text-[#1e3a5f]">
                                        {formatNumber(results.savings.hoursSaved)}
                                    </div>
                                    <div className="text-xs text-gray-500">{formatNumber(results.savings.fteReduction)} FTE</div>
                                </div>
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div className="text-sm text-gray-600 mb-1">CSAT actual</div>
                                    <div className="text-2xl font-bold text-gray-600">
                                        {results.current.csat}%
                                    </div>
                                </div>
                                <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                                    <div className="text-sm text-gray-600 mb-1">CSAT proyectado</div>
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b-2 border-gray-200">
                                        <th className="text-left py-2 text-gray-600">Métrica</th>
                                ...
                                <tbody>
                                    <tr className="border-b border-gray-100">
                                        <td className="py-3 text-gray-700">Horas/mes</td>
                                    ...
                                    <tr className="border-b border-gray-100">
                                        <td className="py-3 text-gray-700">Coste mensual</td>
                                    ...
                                    <tr>
                                        <td className="py-3 text-gray-700">Coste anual</td>
                ...
                <div className="mt-12 text-center bg-white p-8 rounded-xl shadow-md">
                    ...
                    <button className="bg-[#1e3a5f] hover:bg-[#2d5a8f] text-white font-bold py-4 px-10 rounded-lg text-lg shadow-md hover:shadow-lg transition-all">
