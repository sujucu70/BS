    ...
    return (
        <div className="container mx-auto p-4 md:p-8 bg-[#e3e3e3]">
             <header className="text-center py-12">
                ...
                <p className="text-xl md:text-2xl text-[#6D84E3] mt-4">Qué Decimos, Por Qué Funciona y Cómo Ganamos</p>
            </header>
            <main>
                ...
                <section id="solution-vps" className="mb-16 bg-white rounded-lg shadow-md p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <SolutionVPCard
                            ...
                            description="Revoluciona la gestión de citas con una solución híbrida de IA y talento humano que reduce no-shows, elimina esperas y libera a tu equipo."
                ...
                <section id="battle-cards" className="mb-16 bg-white rounded-lg shadow-md p-6 md:p-8">
                    ...
                    <p className="text-center text-lg text-[#6D84E3] mb-12">Nuestra ventaja competitiva de un vistazo. Usa la tabla para un resumen rápido y los desplegables para profundizar.</p>
                ...
                <section id="materials" className="mb-16 bg-white rounded-lg shadow-md p-6 md:p-8">
                    ...
                    <p className="text-center text-lg text-[#6D84E3] mb-12">Recursos clave para preparar tus reuniones, presentar demos y construir tu caso de negocio.</p>
